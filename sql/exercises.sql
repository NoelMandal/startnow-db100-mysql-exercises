...
select payment_id, amount, payment_date from payment where date(payment_date) like "2005-05-27";
...
select  payment_date, amount from payment order by amount desc limit 0, 20;
...
where special_features like "%behind the scenes%" and length < 120 and rental_duration between "5" and "7" order by length desc limit 0, 10;
...
select customer.first_name as customer_first_name, customer.last_name as customer_last_name, actor.first_name as actor_first_name, actor.last_name as actor_last_name from customer left join actor on customer.last_name = actor.last_name order by customer.last_name;
...
select customer.first_name as customer_first_name, customer.last_name as customer_last_name, actor.first_name as actor_first_name, actor.last_name as actor_last_name from customer right join actor on customer.last_name = actor.last_name order by customer.last_name;
...
select customer.first_name as customer_first_name, customer.last_name as customer_last_name, actor.first_name as actor_first_name, actor.last_name as actor_last_name from customer inner join actor on customer.last_name = actor.last_name order by customer.last_name;
...
select city, city.country_id as country from city left join country on city.country_id = country.country_id;
...
select title, description, release_year, film.language_id as language from film left join language on film.language_id = language.language_id;
...
select first_name, last_name, staff.address_id as address, address.address_id as address2, address.district as district, address.postal_code as postal_code, address.city_id as city from staff left join address on staff.address_id = address.address_id left join city on address.city_id = city.city_id;
